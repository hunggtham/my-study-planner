  ...
  return (
    <div className="page-container" style={{ padding: "1rem" }}>
      ...
      {loading ? (
        ...
        <>
          <div className="today-section" style={{ marginBottom: "2rem" }}>
            <div
            ...
            >
              <div>
                <h2 style={{ fontSize: "1.25rem", margin: 0 }}>
                  {selectedDate === format(new Date(), "yyyy-MM-dd")
                    ? "Task hôm nay"
                    : "Task trong ngày đã chọn"}
                </h2>
                <p
                  className="text-muted"
                  style={{ margin: 0, marginTop: "0.25rem" }}
                >
                  Các công việc theo ngày đang được chọn trong lịch trình.
                </p>
              </div>
            </div>
          ...
          <div className="overdue-section" style={{ marginBottom: "2rem" }}>
            ...
            >
              <div>
                ...
                <p
                  ...
                  style={{ margin: 0, marginTop: "0.25rem" }}
                >
                  Các task đã qua ngày nhưng chưa hoàn thành.
                </p>
              </div>
              <Button
                variant="secondary"
            ...
            {overdueTasks.length === 0 ? (
              ...
              >
                Không có task quá hạn chưa hoàn thành.
              </div>
            ) : (

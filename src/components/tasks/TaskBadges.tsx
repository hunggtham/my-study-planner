...
export const CategoryBadge: React.FC<{ category: string; showIcon?: boolean }> = ({ category, showIcon = true }) => {
...
export const PriorityBadge: React.FC<{ priority: string; showIcon?: boolean }> = ({ priority, showIcon = true }) => {
  return (
...
export const StatusBadge: React.FC<{ status: TaskStatus; movedCount?: number }> = ({ status, movedCount }) => {

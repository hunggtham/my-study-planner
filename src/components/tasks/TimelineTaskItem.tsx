...
export const TimelineTaskItem: React.FC<BaseTaskDisplayProps> = ({
  task,
  onUpdate,
  onEdit,
  isProcessing,
  ...
  return (
    <div
      className={`timeline-task-item ${meta.className}`}
      style={{
        position: "relative",
        display: "flex",
        gap: "1rem",
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              task.status === "done" ? "var(--success)" : "var(--bg-dark)",
      ...
      >
        ...
        >
          ...
          <StatusIcon
            size={14}
            color={`var(--${meta.intent === "neutral" ? "text-muted" : meta.intent})`}
          />
        </div>
